...
// pairFlagValueForShellDisplay merges `--flag value` pairs into one string per display line when
// the value does not look like another flag (same rule as [collapseArgsForDisplay]).
